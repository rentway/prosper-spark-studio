        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center group animate-scale-in" style={{ animationDelay: '0.1s' }}>
              <div className="w-20 h-20 bg-gradient-primary rounded-full flex items-center justify-center mx-auto mb-4 group-hover:animate-pulse-glow transition-smooth">
            ...
            <div className="text-center group animate-scale-in" style={{ animationDelay: '0.2s' }}>
              <div className="w-20 h-20 bg-gradient-accent rounded-full flex items-center justify-center mx-auto mb-4 group-hover:animate-pulse-glow transition-smooth">
            ...
            <div className="text-center group animate-scale-in" style={{ animationDelay: '0.4s' }}>
              ...
              <p className="text-muted-foreground">Client satisfaction guaranteed</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="animate-fade-in-up">
                ...
                <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
                  <p>
                    Founded in 2019 with a vision to democratize digital marketing for Canadian businesses, 
                    ProsperOnline has grown from a small team of passionate marketers to a comprehensive 
                    digital solutions provider serving businesses coast to coast.
                  </p>
                  <p>
                ...
                <div className="bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 rounded-3xl p-8 md:p-12 relative overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-center text-lg">
                      To empower Canadian businesses with cutting-edge digital marketing solutions 
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-10 animate-fade-in-up max-w-3xl mx-auto" style={{ animationDelay: '0.2s' }}>
              Join hundreds of Canadian businesses that have transformed their digital presence with our proven strategies. 
